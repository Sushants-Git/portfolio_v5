...
function Blog() {
    return (
        <main className="reference-layout w-[var(--layout-full-width)] mx-auto bg-fold-light-blue">
            <div className="border body">check</div>
            <div className="border gap-between">1</div>
            <aside className="border toc">2</aside>
        </main>
    );
}
